...
public class Controller implements Initializable {
    ...
    public void Login(ActionEvent event){
        ...
        try {
            if (this.loginmodel.isLogin(this.username.getText(),
                ...
                JOptionPane.showMessageDialog(null,"You username or" + "password is not corrected.");
            }
    ...
    private void adminLogin() {
        try {
            ...
            Pane adminRoot = (Pane) adminLoader.load(getClass().getResource("/Admin/AdminDashBoad.fxml").openStream());
